...
<div class="container">
	<div class="row">
		...
		if ( isset( $_REQUEST[ 'deleteid' ] ) ) {
			...
			$sql = "UPDATE `query` SET Isactive=0 WHERE Qid = '$deleteid'";
			...
			if ( mysql_query( $sql ) ) {
				...
				echo "<br><Strong>Query Details Updation Faliure. Try Again</strong><br> Error Details: " . $sql . "<br>" . mysql_error( $conn );
			}
			mysql_close( $conn );
		}
		?>
	...
	<div class="row">
		<div class="col-md-8">
			...
			<?php
			include( "database.php" );
			$sql = "select * from  query where Isactive=1";

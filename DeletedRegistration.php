...
<div class="container">
	<div class="row">
		...
		if ( isset( $_REQUEST[ 'deleteid' ] ) ) {
			...
			$sql = "UPDATE `login` SET Isactive=1 WHERE RegID = $deleteid";
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php
			include( "database.php" );
			$sql = "select * from  login where Isactive=0";
			...
			<tr>
				...
				<td><a href="DeletedRegistration.php?deleteid=<?PHP echo $row['RegID'];?>"><input type="button" Value="Undo Delete" class="btn btn-info btn-sm"></a>
				</td>
			</tr>
			<?php } ?>
			</table>

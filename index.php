...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		...
		<div class="item">
			...
			<div class="carousel-caption">
				<a href="takeexam"><h2 style="color: white; ">Attendance</h2>
                </div>
            </div>
        </div>
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">ACADEMIC MANAGEMENT SYSTEM</h2>
		</div>
		<div class="col-md-6">
			<p>The ACADEMIC MANAGEMENT SYSTEM by <strong>TRISHNA GUPTA  AND  ANAMIKA BHARTI</strong> includes:</p>
			<ul>

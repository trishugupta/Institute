...
$editid=$_GET['gid'];
$sql="select * from query where Qid=$editid && Isactive=1";
...
<strong>Success!</strong>Query Details has been updated.
					...
					echo "<br><Strong>Query Details Updating Faliure. Try Again</strong><br> Error Details: " . $sql . "<br>" . mysql_error( $conn );
				}

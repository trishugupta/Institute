...
<div class="container">
	<div class="row">
		...
		if ( isset( $_REQUEST[ 'deleteid' ] ) ) {
			...
			$sql = "UPDATE  `login` SET Isconfirm=0 WHERE RegID = $deleteid";
			if ( mysql_query( $sql ) ) {
				echo "
<br><br>
...
";
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php
			include( "database.php" );
			$sql = "select * from  login where Isactive=1 && isconfirm=1";
...
<th>Delete</th>		
			...
			<tr>
				...
				<td><a href="updatestudent.php?eno=<?php echo $row['RegID']; ?>"><input type="button" Value="Edit" class="btn btn-info btn-sm"></a>
				</td>
				<td><a href="StudentDetails.php?deleteid=<?php echo $row['RegID']; ?>"><input type="submit" Value="Delete" name="delete" class="btn btn-info btn-sm"></a>
				</td>
			</tr>
			<?php } ?>
			</table>

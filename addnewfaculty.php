	...
	<div class="row">
		<div class="col-md-4">
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					<label for="Password">Faculty Email Id :<span style="color: #ff0000;">*</span></label>
			...
			if ( isset( $_POST[ 'addnewfaculty' ] ) ) {
				...
				$temppass = $_POST[ 'pass' ];
				// adding new faculty
				$sql = "insert flogin (FName, FaName, Address, Gender, JDate, City, FEmail_Id, password, PhNo) values ('$tempfname', '$tempfaname', '$tempaddrs','$tempgender', '$tempjdate', '$tempcity' , '$tempemail' , '$temppass','$tempphno')";
				...
				if ( mysql_query($sql ) ) {
					...
					<strong>Success!</strong> New Faculty Addded Faculty ID is : <strong>" . mysql_insert_id( $conn ) . "</strong></div>";

				} else {
					//error message if SQL query Fails
					echo "<br><Strong>New Faculty Adding Faliure. Try Again</strong><br> Error Details: " . $sql . "<br>" . mysql_error( $conn );
				}

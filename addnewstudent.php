...
<div class="container">
	...
	<div class="row">
		...
		if ( isset( $_POST[ 'addnews' ] ) ) {
			...
			$sql = "Insert into login (FirstName, LastName, FaName, DOB, Address, Gender, CourseId, PhNo , Email_id, password) values ('$tempfname', '$templname', '$tempfaname', '$tempdob', '$tempaddrs' , '$tempgender', '$tempcourse' , $tempphno, '$tempeid' , '$temppass')";
			if ( mysql_query( $sql ) ) {
				...
				<h3 style='margin-top: 10px; margin-bottom: 10px;'>Admission Confirm.! Enrolment Number is : <span style='color:black'><strong>" . mysql_insert_id( $conn ) . "</strong></span></h4></div></center>
				";
			} else {
				//error message if SQL query fails
				echo "<br><Strong>Admission Faliure. Try Again</strong><br> Error Details: " . $sql . "<br>" . mysql_error( $conn );
			}
